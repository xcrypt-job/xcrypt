...
環境変数 \texttt{JOBSCHEDULER} を適切に設定する．シェルが bash なら，
\begin{screen}
\texttt{\$ JOBSCHEDULER=SGE; export JOBSCHEDULER}
\end{screen}

NQS を使う場合は
\begin{screen}
\texttt{\$ JOBSCHEDULER=NQS; export JOBSCHEDULER}
\end{screen}
とする．

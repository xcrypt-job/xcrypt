...
\end{boxnote}
\noindent
と記述する．利用可能なモジュールに関しては\ref{chapmodule}章で述べる．
...
ジョブ作業ディレクトリから\texttt{linkedfile0,...,linkedfile255}キーの
値で指定されているファイルへシンボリックリンクを張
り，\texttt{copiedfile0,...,copiedfile255}キーの値で指定されている作業
ディレクトリ中のファイルのコピーをジョブ作業ディレクトリに作成する．

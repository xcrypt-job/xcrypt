# Config file for the Subsystem A (Camphor3, DELL PowerEdge C6620)
# of ACCMS, Kyoto University installed in 2023
# https://www.iimc.kyoto-u.ac.jp/ja/services/comp/supercomputer/system/specification.html#nexta
use config_common;
use File::Spec;
...
my $MEM = 117*1024; # memory size per proc available for users in MiB

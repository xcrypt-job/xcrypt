...
\end{screen}
shows states of jobs.  In detail, use \texttt{--help} option.
...
\end{screen}
makes states of unfinished jobs aborted.  In case of deleting all
jobs, use \texttt{--all} option.  In case of making (not necessarily
unfinished) jobs aborted, use \texttt{--cancel} option.  In case of
making jobs finished, use \texttt{--invalidated} option.

...
Xcrypt requires Perl 5.10.\texttt{x} and a superset of Bourne shell.
...
under the job working directory, where \texttt{\$myjob} is a job object.
...
Typically, you can write as follows,
\begin{boxnote}
\begin{verbatim}

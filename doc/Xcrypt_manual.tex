...
also provided.  In detail, see \texttt{doc/bulk\_module\_manual.pdf}.
...
\vspace{\baselineskip}
\noindent
creates 4 job objects of
$(\mbox{\texttt{RANGE0}},\mbox{\texttt{RANGE1}}) = (0,2), (0,4),(1,2),
(1,4)$, which can be referred by \texttt{\$VALUE[0]} and
\texttt{\$VALUE[1]}, respectively.

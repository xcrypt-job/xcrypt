...
\xymatrix@C=100pt@R=50pt{
  ...
  *{} & \txt{initialized} \ar[d]|{\txt{\small pre-processing}}
  \ar[rdd]|{\txt{\small \texttt{\$ xcryptdel}}} \ar[ldd]|{\txt{\small job invalidatedl}}      & *{}\\
  *{} & \txt{prepared}    \ar[d]|{\txt{\small job submitted}}
  \ar[rd]|{\txt{\small \texttt{\$ xcryptdel}}} \ar[ld]|{\txt{\small job invalidatedl}}  & *{}\\
  \txt{finished} & \txt{submitted}   \ar[d]|{\txt{\small job queued}}
  \ar[r]|{\txt{\small \texttt{qsub} failed}} \ar[l]|{\txt{\small job invalidatedl}}     & \txt{aborted}\\
  *{} & \txt{queued}      \ar[d]|{\txt{\small job started}}
  \ar[ru]|{\txt{\small job aborted}} \ar[lu]|{\txt{\small job invalidatedl}}   & *{}\\
  *{} & \txt{running}     \ar[d]|{\txt{\small job script done}}
  \ar[ruu]|{\txt{\small job aborted}} \ar[luu]|{\txt{\small job invalidatedl}} & *{}\\
  *{} & \txt{done}        \ar[luuu]|{\txt{\small post-processing}}
  \ar[ruuu]|{\txt{\small job aborted}} & *{}
}
\]
...
Its return value is the array of the pairs of the ids and job objects.
...
\section{Ordinaly methods}\label{apd-coremethod-developer}

...
LIBS="Config-Simple-4.59-without-flock Data-Dumper-2.151 File-Copy-Recursive-0.38 EV-4.11 Event-1.22 AnyEvent-7.17 common-sense-3.6 Canary-Stability-2013 Guard-1.023 Coro-6.55-without-conftest Net-OpenSSH-0.57 Error-0.17018 Text-CSV_XS-0.90 JSON-2.53 Log-Handler-0.75 TermReadKey-2.38"
